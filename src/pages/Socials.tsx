...
const Socials = () => {
  ...
  const socialLinks = [
    {
      name: "TikTok",
      url: "https://www.tiktok.com/@tntservicesmanc",
      icon: (
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/tntservicesmanc?igsh=dHEwa3VsdGY2ODUx&utm_source=qr",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
    ...
    {
      name: "Facebook",
      url: "https://www.facebook.com/share/1CYToDSZa6/?mibextid=wwXIfr",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8">
